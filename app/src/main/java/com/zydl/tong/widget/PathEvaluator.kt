...
class PathEvaluator : TypeEvaluator<PathPoint> {
    ...
    override fun evaluate(t: Float, startValue: PathPoint, endValue: PathPoint): PathPoint {
        ...
        if (endValue.mOperation == PathPoint.THIRD_CURVE) {
            x =
                startValue.mX * oneMiunsT * oneMiunsT * oneMiunsT + 3f * endValue.mContorl0X * t * oneMiunsT * oneMiunsT + 3f * endValue.mContorl1X * t * t * oneMiunsT + endValue.mX * t * t * t
            y =
                startValue.mY * oneMiunsT * oneMiunsT * oneMiunsT + 3f * endValue.mContorl0Y * t * oneMiunsT * oneMiunsT + 3f * endValue.mContorl1Y * t * t * oneMiunsT + endValue.mY * t * t * t
            //二阶贝塞尔曲线
