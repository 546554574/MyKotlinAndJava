...
import com.zydl.tong.ui.activity.RegistActivity;

import butterknife.ButterKnife;
import butterknife.Unbinder;

public abstract class BaseActivity<V, T extends BasePresenterImpl<V>> extends QMUIActivity implements BaseView {
    ...
    public boolean isLoginOut() {
        return getClass().getSimpleName().equals(RegistActivity.class.getSimpleName());
    }
