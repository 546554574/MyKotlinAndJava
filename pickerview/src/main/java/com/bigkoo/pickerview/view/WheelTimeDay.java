...
import com.bigkoo.pickerview.adapter.NumericWheelAdapterDay;
...
public class WheelTimeDay {
    ...
    public WheelTimeDay(View view, boolean[] type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        if (startYear == endYear && startMonth == endMonth) {
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapterDay(startDay, endDay));
            ...
            wv_day.setCurrentItem(day - startDay + 1);
        } else if (year == startYear && month + 1 == startMonth) {
            // 起始日期的天数控制
            if (list_big.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new NumericWheelAdapterDay(startDay, 31));
            } else if (list_little.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new NumericWheelAdapterDay(startDay, 30));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new NumericWheelAdapterDay(startDay, 29));
                } else {

                    wv_day.setAdapter(new NumericWheelAdapterDay(startDay, 28));
                }
            }
            wv_day.setCurrentItem(day - startDay + 1);
            ...
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapterDay(1, endDay));
            } else if (list_little.contains(String.valueOf(month + 1))) {
                if (endDay > 30) {
                    endDay = 30;
                }
            ...
            wv_day.setCurrentItem(day - 1 + 1);
        } else {
            // 判断大小月及是否闰年,用来确定"日"的数据
            if (list_big.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new NumericWheelAdapterDay(1, 31));
            } else if (list_little.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new NumericWheelAdapterDay(1, 30));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new NumericWheelAdapterDay(1, 29));
                } else {

                    wv_day.setAdapter(new NumericWheelAdapterDay(1, 28));
                }
            }
            wv_day.setCurrentItem(day - 1 + 1);
        }
...
//        int maxItem;
        if (list_big.contains(String.valueOf(monthNum))) {
            ...
            wv_day.setAdapter(new NumericWheelAdapterDay(startD, endD));
//            maxItem = endD;
